...
namespace EFAdventureWorks
{
    ...
    public partial class AdventureWorksDW2008BigOrigEntities : DbContext
    {
        public AdventureWorksDW2008BigOrigEntities()
            : base("name=AdventureWorksDW2008BigOrigEntities")
        {
        }
        ...
        public virtual DbSet<TempDateRange> TempDateRanges { get; set; }
        public virtual DbSet<DatabaseLog> DatabaseLogs { get; set; }
        public virtual DbSet<FactFinance> FactFinances { get; set; }
        public virtual DbSet<FactResellerSalesPart> FactResellerSalesParts { get; set; }
